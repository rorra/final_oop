...
public class Fecha {
	...
	public static Fecha fromString(String fechaStr) {
		Pattern p = Pattern.compile("([0-9])+/([0-9])+/([0-9])+");
		Matcher m = p.matcher(fechaStr);
		Fecha fecha = new Fecha();
		fecha.setDia(Integer.parseInt(m.group(1)));
		fecha.setMes(Integer.parseInt(m.group(2)));
		fecha.setAño(Integer.parseInt(m.group(3)));
		return fecha;
	}
